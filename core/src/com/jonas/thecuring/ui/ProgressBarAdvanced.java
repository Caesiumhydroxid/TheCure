...
public class ProgressBarAdvanced extends ProgressBar {

	public ProgressBarAdvanced(float min, float max, float stepSize, boolean vertical, ProgressBarStyle style) {
