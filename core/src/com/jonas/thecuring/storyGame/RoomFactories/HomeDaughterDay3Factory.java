...
public class HomeDaughterDay3Factory extends RoomFactory {
	...
	public Room getRoom(World world) {
		...
		npc = new NPC((Texture)Assets.getInstance().get("daughter"),new String[]{"Willst du heute mit uns spielen?","Ich habe gehört, du musst ins Krankenhaus?"},true,new Rectangle(17,2,8,28));
