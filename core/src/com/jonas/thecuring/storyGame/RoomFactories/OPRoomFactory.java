...
public class OPRoomFactory extends RoomFactory {
	...
	public Room getRoom(World world) {
		...
		room.addActionRoom(0, 0, 0, 0, new TimerAction(world, 10, new NextDayAction(world, new NextDayAction(world, new ChangeRoomAction(world, RoomEnum.HOSPITAL_ROOM_FRIENDS)))));
		return room;
	}
