...
public class HomeDaughterDay4Factory extends RoomFactory{
	@Override
	public Room getRoom(World world) {
		Room room;
		NPC npc = null;
		room = new Room((Texture) Assets.getInstance().get("room_home_daughter"), world,new Vector2(100,10));
		npc = new NPC((Texture)Assets.getInstance().get("daughter"),new String[]{"Ich will nicht, dass du gehst!","Ach Papa..."},false,new Rectangle(17,2,8,28));
