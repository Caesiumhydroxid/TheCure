...
public class Bar6BeerRoomFactory extends RoomFactory {
	...
	public Room getRoom(World world) {
		...
		room.addActionRoom(0, 0, 0, 0, new TimerAction(world, 13, new NextDayAction(world, new ChangeRoomAction(world, RoomEnum.HOME_ROOM,2,5,"Spät in der Nacht kommst du wieder nach Hause und legst dich ins Bett",new SetPlayerAction(world, true, true, null)))));
		return room;
	}
